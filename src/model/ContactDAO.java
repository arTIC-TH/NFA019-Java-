 ...
 */
	public void ajouterContact(ContactModel contM) {
		try {
			...
			.prepareStatement("insert into contacts(nom_cont,prenom_cont,mail_cont,tel_cont") values (?,?,?,?)");
			...
			System.out.Println("SQLException : " + exgetMessage());
...
/**
 * 
 * @return ArrayList : ContMLise
 */
}

public ArrayList<ContactModel> getAllContacts() {
	
	ArrayList<ContactModel> getAllContacts() {
		try {
			...
			while (resultats.next()) {
					...
					contM.setEmail(resultats.getString("mail_cont"));
